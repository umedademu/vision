...
Cloudflare R2に保存した画像を、スクリーンセーバーのように同時に8〜12枚ずつ浮遊表示するWebアプリ。
...
保存済み画像は8〜12枚から毎回ランダムな枚数を同時表示し、1枚ずつ別々のタイミングで5〜10秒ごとに切り替わります。画像は全体が見える大きさで、それぞれ異なる位置・大きさ・速さで宙を漂います。配置と移動範囲を分散し、画像同士が重なる場合も3割程度までに抑えています。
